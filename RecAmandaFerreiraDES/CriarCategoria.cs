...
namespace RecAmandaFerreiraDES
{
    public partial class CriarCategoria : Form
    { // CONEXÃO COM O BANCO DE DADOS
        SqlConnection conn = new SqlConnection(@"workstation id=AmandaFerreiraPortal.mssql.somee.com;packet size=4096;user id=amandafsantos_SQLLogin_1;pwd=ivn4ra5yxf;data source=AmandaFerreiraPortal.mssql.somee.com;persist security info=False;initial catalog=AmandaFerreiraPortal");
